<div x-data="resizedStickyPanel()" class="resized-sticky-panel">
    <button
        type="button"
        x-on:click="toggle()"
        class="fi-icon-btn resized-sticky-panel-trigger"
        title="Pin columns"
    >
        <svg class="fi-icon-btn-icon" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <div class="fi-dropdown-list">
            <template x-for="col in columns" :key="col.name">
                <label class="fi-dropdown-list-item resized-sticky-panel-item">
                    ...
                    />
                    <span class="fi-dropdown-list-item-label" x-text="col.label"></span>
                </label>
            </template>
